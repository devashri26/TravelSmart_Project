...
import { Search, Calendar, MapPin, Loader2, Train, X, Clock } from 'lucide-react';
...
const TrainSearchPage = () => {
  ...
  const handleSearch = async (e) => {
    ...
    try {
      ...
      setTrains(results);
      if (results.length === 0) {
        toast.info('No trains found for your search criteria.');
      } else {
  ...
  const handleSelectTrain = (train) => {
    ...
    if (!isAuthenticated) {
      toast.error('Please login to book train tickets');
      navigate('/login', { state: { from: '/trains', trainData: train } });
      return;
    }
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-cyan-50 via-blue-50 to-purple-50">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <h1 className="text-4xl font-black text-gray-900 mb-8">Search Trains</h1>
        ...
        {trains.length > 0 && !showSeatSelection && (
          <div>
                    ...
                    <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                      <div className="flex items-center space-x-4">
                        ...
                        <div>
                          <div className="flex items-center space-x-2">
                            <p className="text-xl font-bold text-gray-900">{train.trainName}</p>
                            {train.id ? (
                      ...
                      <div className="flex items-center space-x-6">
                        ...
                        <div className="flex flex-col items-center">
                          ...
                          <p className="text-sm text-gray-600">{calculateDuration(train.departureTime, train.arrivalTime)}</p>
                        </div>
                        <div className="text-center">
                      ...
                      <div className="text-center md:text-right">
                        <p className="text-3xl font-bold text-cyan-600">Rs.{train.price}</p>
                        <p className="text-sm text-gray-600 mb-2">{train.availableSeats} seats left</p>
                        <button 
              ...
              <div className="sticky top-0 bg-white border-b border-gray-200 px-6 py-4 flex items-center justify-between">
                <div>
                  ...
                  <p className="text-gray-600">
                    {selectedTrain.name} ({selectedTrain.trainNumber}) | {selectedTrain.origin} to {selectedTrain.destination}
                  </p>
                </div>
                <button
