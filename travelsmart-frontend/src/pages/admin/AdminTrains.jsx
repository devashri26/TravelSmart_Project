...
const AdminTrains = () => {
  ...
  const loadTrains = async () => {
    try {
      setIsLoading(true);
      const response = await adminService.getAllTrains(currentPage, pageSize, searchTerm);
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      if (editingTrain) {
        await adminService.updateTrain(editingTrain.id, formData);
          ...
          <div className="flex items-center justify-between h-16">
            ...
            <div className="flex items-center space-x-4">
              ...
              <button
                ...
                className="px-4 py-2 bg-gradient-to-r from-purple-500 to-indigo-600 text-white rounded-lg hover:shadow-lg transition font-semibold flex items-center space-x-2"
              >
                      ...
                      <tr key={train.id} className="hover:bg-gray-50">
                        <td className="px-6 py-4 whitespace-nowrap">
                          <div className="flex items-center space-x-3">
                            <div className="w-10 h-10 bg-gradient-to-r from-purple-500 to-indigo-600 rounded-lg flex items-center justify-center text-white">
                        ...
                        <td className="px-6 py-4 whitespace-nowrap">
                          <div className="flex items-center space-x-2">
                            ...
                            <div>
                              <div className="text-sm text-gray-900">{train.origin} → {train.destination}</div>
                            </div>
                          </div>
                        </td>
                        <td className="px-6 py-4 whitespace-nowrap">
                          <div>
                            ...
                            <div className="text-xs text-gray-500">
                              Arrival: {formatDateTime(train.arrivalTime)}
                            </div>
                          </div>
                        </td>
                        <td className="px-6 py-4 whitespace-nowrap">
                          <div className="flex items-center">
                            ...
                            <span className="text-sm font-medium text-gray-900">{formatCurrency(train.price)}</span>
                          </div>
                        </td>
                        <td className="px-6 py-4 whitespace-nowrap">
                          <div className="flex items-center">
                            <Users className="w-4 h-4 text-gray-400 mr-1" />
                            <span className="text-sm text-gray-900">{train.availableSeats}</span>
                          </div>
                        </td>
          ...
          <div className="bg-white rounded-xl max-w-2xl w-full max-h-[90vh] overflow-y-auto">
            ...
            <form onSubmit={handleSubmit} className="p-6 space-y-4">
              ...
              <div className="flex space-x-3 pt-4">
                ...
                <button
                  type="submit"
                  className="flex-1 px-4 py-2 bg-gradient-to-r from-purple-500 to-indigo-600 text-white rounded-lg hover:shadow-lg transition font-semibold"
                >
